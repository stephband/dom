...
var i=q[r]||(q[r]=a(e))
E(i,"dom-activate")}}
F(document,"click",g.delegate("a[href]",h)),F(document,"click",g.delegate("a[target]",p)),g.ready(function(){if(g("."+C).forEach(k),M&&/^#\S+$/.test(M))try{g(M).forEach(k)}catch(t){}})}(this),function(t){"use strict"
...
if(o.classes(u).contains(i)){var c=t.target.id
o('a[href$="#'+c+'"]').forEach(function(t){a(t,"click",e)}),t.default()}}}var o=t.dom,i="toggleable",u=o.events.on,a=o.events.off,c=o.events.trigger
