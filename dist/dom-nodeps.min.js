...
if(t&&t!==document&&t!==n&&11!==t.nodeType)return t=t.correspondingUseElement||t,F(e,t)?t:S(e,t.parentNode,n)}function N(e){return e.nextElementSibling||void 0}function M(e){return e.previousElementSibling||void 0}function C(e,t){return e.appendChild(t),e}function k(e,t){if(t instanceof be||t instanceof ye)return C(e,t),t
...
we(ge,{ready:rt.then.bind(rt),get:function(e){return document.getElementById(e)||void 0},find:he.deprecate(function(e){return document.getElementById(e)||void 0},"dom.find(id) is now dom.get(id)"),query:Fe(L,!0),closest:Fe(S,!0),contains:Fe(x,!0),matches:Fe(F,!0),children:w,next:N,previous:M,assign:Fe(a,!0),create:c,clone:Re,identify:v,append:Fe(k,!0),before:Fe(A,!0),after:Fe(O,!0),replace:Fe(B,!0),empty:P,remove:D,isElementNode:d,isTextNode:s,isCommentNode:f,isFragmentNode:l,isInternalLink:m,type:u,tag:p,attribute:Fe(g,!0),classes:b,addClass:Fe(y,!0),removeClass:Fe(T,!0),flashClass:Fe(E,!0),box:j,bounds:z,rectangle:Ne(j,"dom.rectangle(node) now dom.box(node)"),offset:Fe(R,!0),position:K,prefix:Ue,style:Fe(function(e,t){if($e[e])return $e[e](t)
var n=X(e,t)
return"string"==typeof n&&Xe.test(n)?parseFloat(n):n},!0),toPx:tt,toRem:nt,viewportLeft:I,viewportTop:Y,fragmentFromTemplate:ie,fragmentFromChildren:oe,fragmentFromHTML:ae,fragmentFromId:ce,escape:_e,parse:Fe(ue),Event:$,delegate:te,isPrimaryButton:V,preventDefault:U,toKey:G,trapFocus:re,trap:he.deprecate(re,"dom.trap() is now dom.trapFocus()"),events:{on:J,off:Q,trigger:Z},on:he.deprecate(Fe(ne,!0),"dom.on() is now dom.event()"),trigger:Fe(function(e,t){return Z(t,e),t},!0),event:Fe(ne,!0),schedule:Fe(se,!0),animate:Fe(fe,!0),animateScroll:le,scrollTo:Ne(le,"scrollTo(px, node) renamed to animateScroll(px)"),scrollRatio:me,disableScroll:ve,enableScroll:pe,requestEvent:ee,requestFrame:requestAnimationFrame.bind(null),requestFrameN:Fe(Ne(function(e,t){!function n(){return requestAnimationFrame(--e?n:t)}()},"requestFrameN() will be removed soon"),!0),features:Ie,safe:Le({left:0},{right:{get:function(){return e.innerWidth},enumerable:!0,configurable:!0},top:{get:function(){return X("padding-top",document.body)},enumerable:!0,configurable:!0},bottom:{get:function(){return e.innerHeight},enumerable:!0,configurable:!0}})}),Le(ge,{root:{value:document.documentElement,enumerable:!0},head:{value:document.head,enumerable:!0},body:{get:function(){return document.body},enumerable:!0},viewport:{get:function(){return document.scrollingElement},enumerable:!0}}),e.dom=ge}(this),function(e){"use strict"
function t(e){return h.query('a[href$="#'+e+'"]',document).filter(h.isInternalLink).concat(h.query('[data-href="#'+e+'"]',document))}function n(e){var t=M.get(e)
return t||(t={},M.set(e,t)),t}function r(e){var r=n(e),o=e.id
return r.node||(r.node=e),r.buttons||(r.buttons=N.cache&&o&&t(o)),r}function o(e){return N.cache&&e.buttons||e.node.id&&t(e.node.id)}function a(){var e,t=this.data||r(this.target)
t.active||(t.active=!0,this.preventDefault(),p&&console.log("[activate] default | target:",this.target.id,"data:",t),b(t.node).add(L),(e=o(t))&&e.forEach(function(e){h.classes(e).add(x)}))}function i(){var e,t=this.data||r(this.target)
t.active&&(t.active=!1,this.preventDefault(),p&&console.log("[deactivate] default | target:",this.target.id,"data:",t),b(t.node).remove(L),(e=o(t))&&e.forEach(function(e){h.classes(e).remove(x)}))}function c(e){var t=h.create("div",{class:"dialog-layer layer"}),n=h.create("div",{class:"dialog popable"}),r=h.create("button",{class:"close-thumb thumb"})
return h.append(n,e),h.append(t,n),h.append(t,r),h.append(document.body,t),n}function u(e){"mousedown"===e.type&&y(e.currentTarget,"click",function e(t){T(t.currentTarget,"click",e),t.preventDefault()})}function d(e){return!!e.defaultPrevented||(!h.isPrimaryButton(e)||(("keydown"===e.type||"keyup"===e.type)&&13!==e.keyCode||void 0))}function s(e,t){e.preventDefault(),"mousedown"===e.type&&u(e),E(t,"dom-activate",{relatedTarget:e.currentTarget})}function f(e){return(w(e.hash)?e.hash:e.getAttribute("href")).substring(1)}function l(e,t){var n=document.getElementById(t)
...
if(!d(e)&&q[t])return q[t](e)}var p=!1,g=e.Fn,h=e.dom,b=h.classes,y=h.events.on,T=h.events.off,E=h.events.trigger,w=g.isDefined,L="active",x="on",F=e.location,S=F.hash,N={cache:!0},M=new WeakMap
y(document,"dom-activate",function(e){if(!e.defaultPrevented){var t=r(e.target)
if(t.active)return void e.preventDefault()
e.data=t,e.default=a}}),y(document,"dom-deactivate",function(e){if(!e.defaultPrevented){var t=r(e.target)
if(!t.active)return void e.preventDefault()
e.data=t,e.default=i}})
var C=h.trigger("dom-activate"),k={},P={},q={dialog:function(e){var t,n=e.delegateTarget.getAttribute("data-href")||e.delegateTarget.hash||e.delegateTarget.href,r=n.substring(1),o=k[r]||(k[r]=document.getElementById(r))
...
var a=P[r]||(P[r]=c(t))
E(a,"dom-activate")}}
y(document,"click",h.delegate("[href]",m)),y(document,"click",h.delegate("a[target]",v)),h.ready(function(){if(h("."+L).forEach(C),S&&/^#\S+$/.test(S))try{h(S).forEach(C)}catch(e){}})}(this),function(e){"use strict"
...
if(r&&(r.pageX!==t.pageX||r.pageY!==t.pageY))return r}function o(e){k(e)&&(t(e)||(N(document,F.move,a,[e]),N(document,F.cancel,i,[e])))}function a(e,t){t.push(e),l(e,t,e,c)}function i(e,t){c()}function c(){M(document,F.move,a),M(document,F.cancel,i)}function u(e){if(!x[e.target.tagName.toLowerCase()]){var t=e.changedTouches[0],n={target:t.target,pageX:t.pageX,pageY:t.pageY,identifier:t.identifier,touchmove:function(){d.apply(this,arguments)},touchend:function(){s.apply(this,arguments)}}
N(document,S.move,n.touchmove,[n]),N(document,S.cancel,n.touchend,[n])}}function d(e,t){var n=r(e,t[0])
n&&l(e,t,n,f)}function s(e,t){n(e.changedTouches,t[0].identifier)&&f(t)}function f(e){M(document,S.move,e[0].touchmove),M(document,S.cancel,e[0].touchend)}function l(e,t,n,r){var o=n.pageX-t[0].pageX,a=n.pageY-t[0].pageY
...
p(),t.stream.stop()}function p(){M(document,F.move,m),M(document,F.end,v)}function g(e,t){var n=r(e,t)
n&&(e.preventDefault(),t.touch=n,t.timeStamp=e.timeStamp,t.stream.push(n))}function h(e,t){n(e.changedTouches,t.identifier)&&(b(t),t.stream.stop())}function b(e){M(document,S.move,e.activeTouchmove),M(document,S.end,e.activeTouchend)}function y(e,t){var n=E.from(t).map(function(e){return{x:e.pageX-t[0].pageX,y:e.pageY-t[0].pageY,time:(e.timeStamp-t[0].timeStamp)/1e3}}),r={stream:n,target:e,touch:void 0,identifier:t[0].identifier}
return void 0===r.identifier?(N(e,"click",P),N(document,F.move,m,r),N(document,F.cancel,v,r)):(r.activeTouchmove=function(e,t){g(e,t)},r.activeTouchend=function(e,t){h(e,t)},N(document,S.move,r.activeTouchmove,r),N(document,S.end,r.activeTouchend,r)),n.then(function(){setTimeout(function(){M(e,"click",P)},200)}),n}var T=e.Fn,E=e.Stream,w=e.dom,L=8,x={textarea:!0,input:!0,select:!0,button:!0},F={move:"mousemove",cancel:"mouseup dragstart",end:"mouseup"},S={move:"touchmove",cancel:"touchend",end:"touchend"},N=(T.requestTick,w.events.on),M=w.events.off,C=w.events.trigger,k=w.isPrimaryButton,P=w.preventDefault
N(document,"mousedown",o),N(document,"touchstart",u)}(this),function(e){"use strict"
...
g(document,"dom-activate",t),g(document,"dom-deactivate",n),g(e,"scroll",a),o()}(this),function(e){"use strict"
var t=e.dom,n=t.events.on,r=t.matches(".dialog-layer")
n(document,"dom-activate",function(e){e.defaultPrevented||r(e.target.parentNode)&&t.classes(e.target.parentNode).add("active")}),n(document,"dom-deactivate",function(e){e.defaultPrevented||r(e.target.parentNode)&&t.classes(e.target.parentNode).remove("active")})}(this)
