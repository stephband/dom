...
var a=D[r]||(D[r]=c(t))
w(a,"dom-activate")}}
T(document,"click",h.delegate("a[href]",m)),T(document,"click",h.delegate("a[target]",v)),h.ready(function(){if(h("."+F).forEach(P),N&&/^#\S+$/.test(N))try{h(N).forEach(P)}catch(e){}})}(this),function(e){"use strict"
...
if(o.classes(i).contains(a)){var u=e.target.id
o('a[href$="#'+u+'"]').forEach(function(e){c(e,"click",t)}),e.default()}}}var o=e.dom,a="toggleable",i=o.events.on,c=o.events.off,u=o.events.trigger
