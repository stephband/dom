...
return n}function o(e,t,n){this.node=e,this.get=t,this.set=n}function a(e,t){for(var n=Object.keys(t),r=n.length;r--;)n[r]in e?e[n[r]]=t[n[r]]:e.setAttribute(n[r],t[n[r]])}function i(e,t){for(var n=Object.keys(t),r=n.length;r--;)e.setAttributeNS(null,n[r],t[n[r]])}function c(e){if(ze[e])return ze[e](arguments[1])
...
n.add(e),requestAnimationFrame(function(){n.remove(e)})}function w(e){return r(e.children||e.querySelectorAll("*"))}function x(e,t){return t=t||document,r(t.querySelectorAll(e))}function L(e,t){return t.contains?t.contains(e):!!e.parentNode&&(e.parentNode===t||L(e.parentNode,t))}function F(e,t){return t.matches?t.matches(e):t.matchesSelector?t.matchesSelector(e):t.webkitMatchesSelector?t.webkitMatchesSelector(e):t.mozMatchesSelector?t.mozMatchesSelector(e):t.msMatchesSelector?t.msMatchesSelector(e):t.oMatchesSelector?t.oMatchesSelector(e):p(t)===e}function S(e,t){var n=arguments[2]
...
return function(){cancelAnimationFrame(o)}}function fe(e,t,n,r,o){return se(e,Pe(t,Se(r[n],o),De(n,r)))}function le(e){return fe(.6,qe(2),"scrollTop",ge.view,tt(e))}function me(e){return e.scrollTop/(e.scrollHeight-e.clientHeight)}function ve(e){e=e||document.documentElement
...
var t=e.scrollLeft,n=e.scrollTop
e.style.overflow="",n&&(e.scrollTop=n),t&&(e.scrollLeft=t)}function ge(e){return x(e,document)}var he=e.Fn,be=e.Node,ye=e.SVGElement,Te=e.CustomEvent,Ee=e.Stream,we=Object.assign,xe=Object.defineProperties,Le=he.cache,Fe=(he.compose,he.curry),Se=he.denormalise,Me=he.deprecate,Ne=he.id,Ce=he.noop,ke=he.overload,Pe=he.pipe,qe=he.pow,De=he.set,Ae=he.requestTick,Oe=he.toType,Be=Array.prototype,He=/\s+/,Xe=/px$/,Ie=xe({},{inputEventsWhileDisabled:{get:Le(function(){var e=document.createElement("input"),t=$("featuretest"),n=!1
return C(document.body,e),e.disabled=!0,e.addEventListener("featuretest",function(e){n=!0}),e.dispatchEvent(t),q(e),n}),enumerable:!0},template:{get:Le(function(){return"content"in document.createElement("template")}),enumerable:!0},textareaPlaceholderSet:{get:Le(function(){var e=document.createElement("textarea")
...
we(ge,{ready:rt.then.bind(rt),get:function(e){return document.getElementById(e)||void 0},find:he.deprecate(function(e){return document.getElementById(e)||void 0},"dom.find(id) is now dom.get(id)"),query:Fe(x,!0),closest:Fe(S,!0),contains:Fe(L,!0),matches:Fe(F,!0),children:w,next:M,previous:N,assign:Fe(a,!0),create:c,clone:Re,identify:v,append:Fe(k,!0),before:Fe(A,!0),after:Fe(O,!0),replace:Fe(B,!0),empty:P,remove:D,isElementNode:d,isTextNode:s,isCommentNode:f,isFragmentNode:l,isInternalLink:m,type:u,tag:p,attribute:Fe(g,!0),classes:b,addClass:Fe(y,!0),removeClass:Fe(T,!0),flashClass:Fe(E,!0),box:j,bounds:z,rectangle:Me(j,"dom.rectangle(node) now dom.box(node)"),offset:Fe(R,!0),position:K,prefix:Ue,style:Fe(function(e,t){if($e[e])return $e[e](t)
var n=X(e,t)
...
function t(e){return h.query('[href$="#'+e+'"]',h.body).filter(F(y,{a:h.isInternalLink,default:function(){return!0}})).concat(h.query('[data-href="#'+e+'"]',document))}function n(e){var t=P.get(e)
return t||(t={},P.set(e,t)),t}function r(e){var r=n(e),o=e.id
return r.node||(r.node=e),r.buttons||(r.buttons=k.cache&&o&&t(o)),r}function o(e){return k.cache&&e.buttons||e.node.id&&t(e.node.id)}function a(){var e,t=this.data||r(this.target)
t.active||(t.active=!0,this.preventDefault(),p&&console.log("[activate] default | target:",this.target.id,"data:",t),b(t.node).add(S),(e=o(t))&&e.forEach(function(e){h.classes(e).add(M)}))}function i(){var e,t=this.data||r(this.target)
t.active&&(t.active=!1,this.preventDefault(),p&&console.log("[deactivate] default | target:",this.target.id,"data:",t),b(t.node).remove(S),(e=o(t))&&e.forEach(function(e){h.classes(e).remove(M)}))}function c(e){var t=h.create("div",{class:"dialog-layer layer"}),n=h.create("div",{class:"dialog popable"}),r=h.create("button",{class:"close-thumb thumb"})
...
if(n){h.classes(n)
h.activeMatchers.find(q(n))?s(e,n):h.activateOther&&h.activateOther(n)}}function m(e){if(!d(e)&&(!e.delegateTarget.hostname||h.isInternalLink(e.delegateTarget))){var t=f(e.delegateTarget)
t&&l(e,t)}}function v(e){var t=e.delegateTarget.target
if(!d(e)&&B[t])return B[t](e)}var p=!1,g=e.Fn,h=e.dom,b=h.classes,y=h.tag,T=h.events.on,E=h.events.off,w=h.events.trigger,x=g.curry,L=g.isDefined,F=g.overload,S="active",M="on",N=e.location,C=N.hash,k={cache:!0},P=new WeakMap,q=x(function(e,t){return t(e)})
Object.defineProperties(h,{activeMatchers:{value:[]}}),T(document,"dom-activate",function(e){if(!e.defaultPrevented){var t=r(e.target)
...
var D=h.trigger("dom-activate"),A={},O={},B={dialog:function(e){var t,n=e.delegateTarget.getAttribute("data-href")||e.delegateTarget.hash||e.delegateTarget.href,r=n.substring(1),o=A[r]||(A[r]=document.getElementById(r))
...
var a=O[r]||(O[r]=c(t))
w(a,"dom-activate")}}
T(document,"click",h.delegate("a[href]",m)),T(document,"click",h.delegate("a[target]",v)),h.ready(function(){if(h("."+S).forEach(D),C&&/^#\S+$/.test(C))try{h(C).forEach(D)}catch(e){}})}(this),function(e){"use strict"
...
if(r&&(r.pageX!==t.pageX||r.pageY!==t.pageY))return r}function o(e){k(e)&&(t(e)||(M(document,F.move,a,[e]),M(document,F.cancel,i,[e])))}function a(e,t){t.push(e),l(e,t,e,c)}function i(e,t){c()}function c(){N(document,F.move,a),N(document,F.cancel,i)}function u(e){if(!L[e.target.tagName.toLowerCase()]){var t=e.changedTouches[0],n={target:t.target,pageX:t.pageX,pageY:t.pageY,identifier:t.identifier,touchmove:function(){d.apply(this,arguments)},touchend:function(){s.apply(this,arguments)}}
...
if(!(o*o+a*a<x*x)){var i,c=t[0],u=t[0].target
...
if(a(n)){var r=o.identify(n)
o('a[href$="#'+r+'"]').forEach(function(n){i(n,"click",t,e.target)}),e.default()}}}function r(e,n,r){if(e.default){var i=e.target
if(a(i)){var u=e.target.id
o('a[href$="#'+u+'"]').forEach(function(e){c(e,"click",t)}),e.default()}}}var o=e.dom,a=o.matches(".toggleable, [toggleable]"),i=o.events.on,c=o.events.off,u=o.events.trigger
i(document,"dom-activate",n),i(document,"dom-deactivate",r),o.activeMatchers.push(a)}(this),function(e){"use strict"
function t(e){if(e.default){var t=e.target
if(a(t)){var n=o.query(".switchable",t.parentNode),i=n.indexOf(t)
n.splice(i,1)
var u=n.filter(o.matches(".active"))
e.default(),r.from(u).each(c)}}}function n(e){if(e.default){var t=e.target
a(t)&&e.default()}}var r=e.Fn,o=e.dom,a=o.matches(".switchable, [switchable]"),i=o.events.on,c=o.trigger("dom-deactivate")
i(document,"dom-activate",t),i(document,"dom-deactivate",n),o.activeMatchers.push(a)}(this),function(e){"use strict"
...
return e.parentNode.clientWidth-n}function r(e,t){var n=i.box(e).left,r=i.box(t).left,o=Math.round(n-r-i.style("margin-left",t))
...
var r=i.box(t).left,o=i.box(n).left,a=r-o-i.style("margin-left",t)
n.style.transform="translate("+-a+"px, 0px)",e.preventDefault()}}})}(this),function(e){"use strict"
var t=e.Fn,n=e.dom,r=t.noop,o=n.events.on,a=n.events.off,i=n.events.trigger,c=n.disableScroll,u=n.enableScroll,d=n.trapFocus,s=r,f=n.matches(".focusable, [focusable]")
...
o(e.target,"transitionend",t),u(n.root)}}),n.activeMatchers.push(f)}(this),function(e){"use strict"
function t(e,t,n){function u(){clearTimeout(s),i(d,"transitionend",u),c(d)}if(e.default){var d=e.target
if(r(d)){var s=setTimeout(u,1e3*o)
a(d,"transitionend",u),e.default()}}}var n=e.dom,r=n.matches(".removeable, [removeable]"),o=1,a=n.events.on,i=n.events.off,c=n.remove
a(document,"dom-deactivate",t)}(this),function(e){function t(e){if(e.default){var t=e.target
if(g(t)&&t!==i){if(i){if(t===i)return
E(),u.trigger("dom-deactivate",i)}var n,r,o=e.timeStamp;(T>o||o>T+h)&&(n=v(u.view,t),r=u.safe.top,T=o+1e3*b,E=l(b,y,"scrollTop",u.view,n[1]-r)),e.default(),i=t}}}function n(e){if(e.default){var t=e.target
g(t)&&(e.default(),t===i&&(i=void 0))}}function r(){return{left:0,top:0,right:e.innerWidth,bottom:e.innerHeight,width:e.innerWidth,height:e.innerHeight}}function o(){for(var e=u(".locateable"),t=e.map(m).sort(d("top")),n=r(),o=-1;t[++o]&&!(t[o].top>n.height/2););if(!(--o<0||o>=t.length)){var a=e[o]
if(i){if(a===i)return
u.trigger("dom-deactivate",i)}u.trigger("dom-activate",a)}}function a(e){T>=e.timeStamp||(T=e.timeStamp,o())}var i,c=e.Fn,u=e.dom,d=c.by,s=c.noop,f=c.exponentialOut,l=u.animate,m=u.box,v=u.offset,p=u.events.on,g=u.matches(".locateable, [locateable]"),h=90,b=.8,y=f(6),T=0,E=s
p(document,"dom-activate",t),p(document,"dom-deactivate",n),p(e,"scroll",a),o(),u.activeMatchers.push(g)}(this)
