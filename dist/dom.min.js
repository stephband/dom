...
function e(t,e,n,r){return r.toString=function(){return/function\s*[\w\d]*\s*\([,\w\d\s]*\)/.exec(n.toString())+" { ["+t+"] }"},St&&Object.defineProperty(r,"length",{value:e}),r}function n(t,e){return function(){return console.warn("Deprecation warning: "+e),t.apply(this,arguments)}}function r(){if(!t.console)return e
...
return console.groupEnd(),console.log("⬅",t),t}}function o(){}function i(t){return t}function u(){return this}function a(t,e){return e(t)}function c(t,e){return function(){e.apply(this,O(arguments,t))}}function s(t,e){return function(n){return t(e(n))}}function f(){var t=arguments
...
return n}function T(t){return parseInt(t,10)}function M(t){return t.toString()}function C(t,e,n){var r=D(t,function(t){return e(n,t)})
t.splice(r,0,n)}function D(t,e){for(var n=t.length,r=n+n%2,o=0;(r=Math.floor(r/2))&&o+r<=n;)e(t[o+r-1])>=0&&(o+=r,r+=r%2)
return o}function S(t,e){return-1===t.indexOf(e)&&t.push(e),t}function A(t,e){return t.push(e),t}function L(t,e){return t===e?0:t>e?1:-1}function O(t,e){return Array.isArray(e)?e.concat(Array.isArray(t)?t:E(t)):e.concat?e.concat(t):E(e).concat(Array.isArray(t)?t:E(t))}function k(t,e){return e.includes?e.includes(t):e.contains?e.contains(t):wt.includes?wt.includes.call(e,t):-1!==wt.indexOf.call(e,t)}function q(t,e){return e.map?e.map(t):wt.map.call(e,t)}function _(t,e){var n,r
...
return t.on("pull",this.shift)},tap:function(t){return this.shift=bt.compose(function(e){return void 0!==e&&t(e),e},this.shift),this},toJSON:function(){return this.reduce(A,[])},toString:function(){return this.reduce(rt,"")},process:n(function(t){return t(this)},".process() is deprecated"),last:n(function(){var t=this
...
var e=-1
return new bt(function n(){return++e>=t.length?void 0:void 0===t[e]?n():t[e]})},Timer:ht,nothing:Ct,id:i,noop:o,self:u,cache:l,compose:s,curry:h,choose:g,flip:v,once:p,overload:h(m),pipe:f,throttle:pt,wait:vt,equals:h(y),is:h(Ot),isDefined:b,isIn:h(kt,!0),isNot:h(F),and:h(function(t,e){return!(!t||!e)}),not:function(t){return!t},or:h(function(t,e){return t||e}),xor:h(function(t,e){return(t||e)&&!!t!=!!e}),isGreater:h(function(t,e){return e>t}),by:h(function(t,e,n){return L(e[t],n[t])},!0),byGreater:h(L),byAlphabet:h(function(t,e){return Tt.localeCompare.call(t,e)}),toType:w,toClass:x,toArray:E,toString:M,toInt:T,toFloat:parseFloat,toPlainText:function(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"")},toStringType:function(t,e){return function(n){for(var r=e.length;r--;)if(t[e[r]].test(n))return e[r]
try{return JSON.parse(n),"json"}catch(t){}return"string"}}(Lt,["url","date","email","float","int"]),concat:h(O,!0),contains:h(k,!0),diff:h(X,!0),each:h(_,!0),filter:h(P,!0),find:h($,!0),insert:h(z,!0),intersect:h(R,!0),last:N,latest:gt,map:h(q,!0),reduce:h(j,!0),remove:h(H,!0),rest:h(B,!0),sort:h(G,!0),split:h(W,!0),take:h(I,!0),unite:h(Y,!0),unique:K,assign:h(Mt,!0,2),get:h(J,!0),set:h(U,!0),getPath:h(et,!0),setPath:h(nt,!0),invoke:h(function(t,e,n){return n[t].apply(n,e)},!0),add:h(function(t,e){return e+t}),multiply:h(function(t,e){return e*t}),mod:h(function(t,e){return e%t}),min:h(function(t,e){return t>e?e:t}),max:h(function(t,e){return t<e?e:t}),pow:h(function(t,e){return Math.pow(e,t)}),exp:h(function(t,e){return Math.pow(t,e)}),log:h(function(t,e){return Math.log(e)/Math.log(t)}),root:h(function(t,e){return Math.pow(e,1/t)}),gcd:h(at),lcm:h(ct),todB:function(t){return 20*Math.log10(t)},toLevel:function(t){return Math.pow(2,t/6)},toRad:function(t){return t/Dt},toDeg:function(t){return t*Dt},factorise:function(t,e){var n=at(t,e)
...
function e(t,e){return e(t)}function n(t){return void 0!==t}function r(t){return"done"===t.status}function o(t){if(!t.shift)throw new Error("Stream: Source must create an object with .shift() "+Source)}function i(t,e){var n=e[D]
...
var n,r=this,i=new Promise(function(i,c){function s(){r.status="done",l=S}function f(t,e){delete r[D],t?l=new a(l,t,s):s(),i(e)}var l
n=function(){var i=u(r)
return l=new t(i,f,e),g&&o(l),l.stop||(l.stop=E),n=function(){return l},l}})
this[D]={},this.push=function(){var t=n()
...
this.cancel=n.cancel||E,this.end=e,this.id=i(r)}var g=!1,y=t.Fn,b=Array.prototype,F=Object.assign,w=(y.curry,y.each),x=y.latest,E=y.noop,T=y.now,M=(y.nothing,y.rest,y.throttle,y.Timer),C=y.toArray,D=Symbol("events"),S={shift:E,push:E,start:E,stop:E}
F(a.prototype,S,{shift:function(){return--this.n<1&&this.done(),this.source.shift()}}),F(s.prototype,{shift:function(){var t=this._buffer,e=this._notify
...
return t="number"==typeof t?new M(t):t instanceof c?new h(t):t||A,new c(function(e,n){return new v(e,n,t)})},F(m.prototype,{shift:function(){var t=this.value
return this.value=void 0,t},stop:function(){(0,this.cancel)(this.id),this.end()}}),c.clock=function(t){return new c(m,"number"==typeof t?new M(t):t||A)},c.prototype=F(Object.create(y.prototype),{clone:function(){var t=this,e=this.shift,n=[],r=[],o=new c(function(o,i){var u=r
...
return y.prototype.each.apply(n,e),this.on("push",function(){y.prototype.each.apply(n,e)})},pipe:function(t){return this.each(t.push),y.prototype.pipe.apply(this,arguments)},on:function(t,e){var n=this[D]
return n?((n[t]||(n[t]=[])).push(e),this):this},off:function(t,e){var n=this[D]
if(!n)return this
...
if(e&&e!==document&&e!==n&&11!==e.nodeType)return e=e.correspondingUseElement||e,M(t,e)?e:C(t,e.parentNode,n)}function D(t){return t.nextElementSibling||void 0}function S(t){return t.previousElementSibling||void 0}function A(t,e){return t.appendChild(e),t}function L(t,e){if(e instanceof yt||e instanceof bt)return A(t,e),e
if(e.length){return(e.reduce?e:Nt.slice.call(e)).reduce(A,t),e}}function O(t){for(;t.lastChild;)t.removeChild(t.lastChild)}function k(t){t.parentNode&&t.parentNode.removeChild(t)}function q(t){t instanceof yt||t instanceof bt?k(t):Nt.forEach.call(t,k)}function _(t,e){t.parentNode&&t.parentNode.insertBefore(e,t)}function P(t,e){t.parentNode&&t.parentNode.insertBefore(e,t.nextSibling)}function N(t,e){return _(t,e),q(t),t}function j(t){return t.split("(")[1].split(")")[0].split(/\s*,\s*/)}function B(e,n){return t.getComputedStyle?t.getComputedStyle(n,null).getPropertyValue(e):0}function I(e){var n=document.body,r=document.documentElement,o=e.getBoundingClientRect(),i=t.pageXOffset||r.scrollLeft||n.scrollLeft,u=r.clientLeft||n.clientLeft||0
...
return[r.left-n.left,r.top-n.top]}function Y(t,e){var n=xt({},Gt,e),r=new Ft(t,n)
return e&&(delete e.detail,xt(r,e)),r}function K(t){t.preventDefault()}function G(t){return 1===t.which&&!t.ctrlKey&&!t.altKey&&!t.shiftKey}function J(t){return Ut[t.keyCode]}function U(t,n,r,o){n=n.split(jt)
...
return document.addEventListener("focus",n,!0),_t(e),Vt=function(){Vt=At,document.removeEventListener("focus",n,!0),_t(function(){r.focus()})}}function ot(t){if(t.domFragmentFromChildren)return t.domFragmentFromChildren
var e=a("fragment")
return t.domFragmentFromChildren=e,L(e,t.childNodes),e}function it(t,e){var n=document.createElement(e||"div")
...
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,Ot(e,Ct(r[n],o),qt(n,r)))}function dt(t){return lt(.6,kt(2),"scrollTop",mt.view,ee(t))}function ht(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function pt(t){t=t||document.documentElement
...
var e=t.scrollLeft,n=t.scrollTop
t.style.overflow="",n&&(t.scrollTop=n),e&&(t.scrollLeft=e)}function mt(t){return E(t,document)}var gt=t.Fn,yt=t.Node,bt=t.SVGElement,Ft=t.CustomEvent,wt=t.Stream,xt=Object.assign,Et=Object.defineProperties,Tt=gt.cache,Mt=(gt.compose,gt.curry),Ct=gt.denormalise,Dt=gt.deprecate,St=gt.id,At=gt.noop,Lt=gt.overload,Ot=gt.pipe,kt=gt.pow,qt=gt.set,_t=gt.requestTick,Pt=gt.toType,Nt=Array.prototype,jt=/\s+/,Bt=/px$/,It=Et({},{inputEventsWhileDisabled:{get:Tt(function(){var t=document.createElement("input"),e=Y("featuretest"),n=!1
return A(document.body,t),t.disabled=!0,t.addEventListener("featuretest",function(t){n=!0}),t.dispatchEvent(e),k(t),n}),enumerable:!0},template:{get:Tt(function(){return"content"in document.createElement("template")}),enumerable:!0},textareaPlaceholderSet:{get:Tt(function(){var t=document.createElement("textarea")
...
return function(t){return r[t]||(r[t]=e(t))}}(["Khtml","O","Moz","Webkit","ms"]),Gt={bubbles:!0},Jt=Symbol("events"),Ut={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",27:"escape",32:"space",33:"pageup",34:"pagedown",35:"pageright",36:"pageleft",37:"left",38:"up",39:"right",40:"down",46:"delete",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",89:"y",90:"z",91:"cmd",93:"cmd",186:";",187:"=",188:",",189:"-",190:".",191:"/",219:"[",220:"\\",221:"]",222:"'",224:"cmd"},Vt=At,Qt={xml:"application/xml",html:"text/html",svg:"image/svg+xml"},Zt=function(){var t=document.createElement("pre"),e=document.createTextNode("")
return t.appendChild(e),function(n){return e.textContent=n,t.innerHTML}}(),te=/(\d*\.?\d+)r?em/,ee=Lt(Pt,{number:St,string:function(t){var e,n
if(e=te.exec(t))return n=parseFloat(e[1]),st()*n
throw new Error("dom: "+t+"' cannot be parsed as rem, em or %.")}}),ne=Lt(Pt,{number:function(t){return t/st()}}),re=new Promise(function(e,n){function r(){document.removeEventListener("DOMContentLoaded",r),t.removeEventListener("load",r),e()}document.addEventListener("DOMContentLoaded",r),t.addEventListener("load",r)})
xt(mt,{ready:re.then.bind(re),get:function(t){return document.getElementById(t)||void 0},find:gt.deprecate(function(t){return document.getElementById(t)||void 0},"dom.find(id) is now dom.get(id)"),query:Mt(E,!0),closest:Mt(C,!0),contains:Mt(T,!0),matches:Mt(M,!0),children:x,next:D,previous:S,assign:Mt(i,!0),create:a,clone:Rt,identify:p,append:Mt(L,!0),before:Mt(_,!0),after:Mt(P,!0),replace:Mt(N,!0),empty:O,remove:q,isElementNode:s,isTextNode:f,isCommentNode:l,isFragmentNode:d,isInternalLink:h,type:c,tag:v,attribute:Mt(m,!0),classes:y,addClass:Mt(b,!0),removeClass:Mt(F,!0),flashClass:Mt(w,!0),box:H,bounds:W,rectangle:Dt(H,"dom.rectangle(node) now dom.box(node)"),offset:Mt(R,!0),position:X,prefix:Kt,style:Mt(function(t,e){if(Yt[t])return Yt[t](e)
var n=B(t,e)
return"string"==typeof n&&Bt.test(n)?parseFloat(n):n},!0),toPx:ee,toRem:ne,viewportLeft:I,viewportTop:$,fragmentFromTemplate:ut,fragmentFromChildren:ot,fragmentFromHTML:it,fragmentFromId:at,escape:Zt,parse:Mt(ct),Event:Y,delegate:et,isPrimaryButton:G,preventDefault:K,toKey:J,trapFocus:rt,trap:gt.deprecate(rt,"dom.trap() is now dom.trapFocus()"),events:{on:U,off:V,trigger:Q},on:gt.deprecate(Mt(nt,!0),"dom.on() is now dom.event()"),trigger:Mt(function(t,e){return Q(e,t),e},!0),event:Mt(nt,!0),transition:Mt(ft,!0),schedule:Dt(ft,"dom: .schedule() is now .transition()"),animate:Mt(lt,!0),animateScroll:dt,scrollTo:Dt(dt,"scrollTo(px, node) renamed to animateScroll(px)"),scrollRatio:ht,disableScroll:pt,enableScroll:vt,requestEvent:tt,requestFrame:requestAnimationFrame.bind(null),requestFrameN:Mt(Dt(function(t,e){!function n(){return requestAnimationFrame(--t?n:e)}()},"requestFrameN() will be removed soon"),!0),features:It,safe:Et({left:0},{right:{get:function(){return t.innerWidth},enumerable:!0,configurable:!0},top:{get:function(){return B("padding-top",document.body)},enumerable:!0,configurable:!0},bottom:{get:function(){return t.innerHeight},enumerable:!0,configurable:!0}})}),Et(mt,{root:{value:document.documentElement,enumerable:!0},head:{value:document.head,enumerable:!0},body:{get:function(){return document.body},enumerable:!0},view:{get:function(){return document.scrollingElement},enumerable:!0},viewport:{get:function(){return console.warn("Deprecated: dom.viewport is now dom.view"),document.scrollingElement},enumerable:!0}}),t.dom=mt}(this),function(t){"use strict"
function e(t){return g.query('[href$="#'+t+'"]',g.body).filter(M(b,{a:g.isInternalLink,default:function(){return!0}})).concat(g.query('[data-href="#'+t+'"]',document))}function n(t){var e=O.get(t)
...
if(n){g.classes(n)
g.activeMatchers.find(k(n))?f(t,n):g.activateOther&&g.activateOther(n)}}function h(t){if(!s(t)&&(!t.delegateTarget.hostname||g.isInternalLink(t.delegateTarget))){var e=l(t.delegateTarget)
e&&d(t,e)}}function p(t){var e=t.delegateTarget.target
if(!s(t)&&N[e])return N[e](t)}var v=!1,m=t.Fn,g=t.dom,y=g.classes,b=g.tag,F=g.events.on,w=g.events.off,x=g.events.trigger,E=m.curry,T=m.isDefined,M=m.overload,C="active",D="on",S=t.location,A=S.hash,L={cache:!0},O=new WeakMap,k=E(function(t,e){return e(t)})
...
var i=P[r]||(P[r]=a(e))
x(i,"dom-activate")}}
F(document,"click",g.delegate("a[href]",h)),F(document,"click",g.delegate("a[target]",p)),g.ready(function(){if(g("."+C).forEach(q),A&&/^#\S+$/.test(A))try{g(A).forEach(q)}catch(t){}})}(this),function(t){"use strict"
...
if(r&&(r.pageX!==e.pageX||r.pageY!==e.pageY))return r}function o(t){L(t)&&(e(t)||(D(document,M.move,i,[t]),D(document,M.cancel,u,[t])))}function i(t,e){e.push(t),d(t,e,t,a)}function u(t,e){a()}function a(){S(document,M.move,i),S(document,M.cancel,u)}function c(t){if(!T[t.target.tagName.toLowerCase()]){var e=t.changedTouches[0],n={target:e.target,pageX:e.pageX,pageY:e.pageY,identifier:e.identifier,touchmove:function(){s.apply(this,arguments)},touchend:function(){f.apply(this,arguments)}}
D(document,C.move,n.touchmove,[n]),D(document,C.cancel,n.touchend,[n])}}function s(t,e){var n=r(t,e[0])
n&&d(t,e,n,l)}function f(t,e){n(t.changedTouches,e[0].identifier)&&l(e)}function l(t){S(document,C.move,t[0].touchmove),S(document,C.cancel,t[0].touchend)}function d(t,e,n,r){var o=n.pageX-e[0].pageX,i=n.pageY-e[0].pageY
...
v(),e.stream.stop()}function v(){S(document,M.move,h),S(document,M.end,p)}function m(t,e){var n=r(t,e)
n&&(t.preventDefault(),e.touch=n,e.timeStamp=t.timeStamp,e.stream.push(n))}function g(t,e){n(t.changedTouches,e.identifier)&&(y(e),e.stream.stop())}function y(t){S(document,C.move,t.activeTouchmove),S(document,C.end,t.activeTouchend)}function b(t,e){var n=w.from(e).map(function(t){return{x:t.pageX-e[0].pageX,y:t.pageY-e[0].pageY,time:(t.timeStamp-e[0].timeStamp)/1e3}}),r={stream:n,target:t,touch:void 0,identifier:e[0].identifier}
return void 0===r.identifier?(D(t,"click",O),D(document,M.move,h,r),D(document,M.cancel,p,r)):(r.activeTouchmove=function(t,e){m(t,e)},r.activeTouchend=function(t,e){g(t,e)},D(document,C.move,r.activeTouchmove,r),D(document,C.end,r.activeTouchend,r)),n.then(function(){setTimeout(function(){S(t,"click",O)},200)}),n}var F=t.Fn,w=t.Stream,x=t.dom,E=8,T={textarea:!0,input:!0,select:!0,button:!0},M={move:"mousemove",cancel:"mouseup dragstart",end:"mouseup"},C={move:"touchmove",cancel:"touchend",end:"touchend"},D=(F.requestTick,x.events.on),S=x.events.off,A=x.events.trigger,L=x.isPrimaryButton,O=x.preventDefault
D(document,"mousedown",o),D(document,"touchstart",c)}(this),function(t){"use strict"
...
v(document,"dom-activate",e),v(document,"dom-deactivate",n),v(t,"scroll",i),o(),c.activeMatchers.push(m)}(this)
