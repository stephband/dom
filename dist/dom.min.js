...
u[i]=o[2]?o[3]:parseFloat(o[3]),n.push(u)}U(i,n,u)}return tt(t,e,u,r)}function et(t,e){return Nt.lastIndex=0,Z(Nt,t,e)}function nt(t,e,n){return Nt.lastIndex=0,tt(Nt,t,e,n)}function rt(t,e){return t+e}function ot(t,e){return e+t}function it(t,e,n){for(var r=-1,o="";o.length<e-n.length;)o+=t[++r%t.length]
...
r>i?s=c:f=c,c=.5*(f-s)+s}return c}function dt(t){return _t.then(t),!0}function ht(t,e){function n(){var t=o.length
...
function e(t){var e=_t.slice.call(arguments,1)
return function(){_t.push.apply(arguments,e),t.apply(null,arguments)}}function n(t){return(/^\//.test(t)?"":"/")+t}function r(t){var e,n=[],r=n.length=t.length
...
if(e.length){return(e.reduce?e:_t.slice.call(e)).reduce(L,t),e}}function k(t){for(;t.lastChild;)t.removeChild(t.lastChild)}function O(t){t.parentNode&&t.parentNode.removeChild(t)}function N(t){t instanceof yt||t instanceof bt?O(t):_t.forEach.call(t,O)}function q(t,e){t.parentNode&&t.parentNode.insertBefore(e,t)}function P(t,e){t.parentNode&&t.parentNode.insertBefore(e,t.nextSibling)}function _(t,e){return q(t,e),N(t),t}function j(t){return t.split("(")[1].split(")")[0].split(/\s*,\s*/)}function B(e,n){return t.getComputedStyle?t.getComputedStyle(n,null).getPropertyValue(e):0}function I(e){var n=document.body,r=document.documentElement,o=e.getBoundingClientRect(),i=t.pageXOffset||r.scrollLeft||n.scrollLeft,u=r.clientLeft||n.clientLeft||0
...
return document.addEventListener("focus",n,!0),qt(e),Vt=function(){Vt=Lt,document.removeEventListener("focus",n,!0),qt(function(){r.focus()})}}function ot(t){if(t.domFragmentFromChildren)return t.domFragmentFromChildren
var e=a("fragment")
...
var n=v(e)
return"template"!==n||It.template||N(e),"template"===n?ut(e):"script"===n?it(e.innerHTML,m("data-parent-tag",e)):ot(e)}function ct(e,n){var r,o=Qt[e]
...
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,kt(e,Dt(r[n],o),Nt(n,r)))}function dt(t){return lt(.6,Ot(2),"scrollTop",mt.viewport,ee(t))}function ht(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function pt(t){t=t||document.documentElement
...
return t.appendChild(e),function(n){return e.textContent=n,t.innerHTML}}(),te=/(\d*\.?\d+)r?em/,ee=At(Pt,{number:Mt,string:function(t){var e,n
...
Et(mt,{ready:re.then.bind(re),get:function(t){return document.getElementById(t)||void 0},find:gt.deprecate(function(t){return document.getElementById(t)||void 0},"dom.find(id) is now dom.get(id)"),query:Ct(x,!0),closest:Ct(D,!0),contains:Ct(T,!0),matches:Ct(C,!0),children:E,next:S,previous:M,assign:Ct(i,!0),create:a,clone:Rt,identify:p,append:Ct(A,!0),before:Ct(q,!0),after:Ct(P,!0),replace:Ct(_,!0),empty:k,remove:N,isElementNode:s,isTextNode:f,isCommentNode:l,isFragmentNode:d,isInternalLink:h,type:c,tag:v,attribute:Ct(m,!0),classes:y,addClass:Ct(b,!0),removeClass:Ct(F,!0),flashClass:Ct(w,!0),box:H,bounds:W,rectangle:St(H,"dom.rectangle(node) now dom.box(node)"),offset:Ct(R,!0),position:X,prefix:Kt,style:Ct(function(t,e){if(Yt[t])return Yt[t](e)
var n=B(t,e)
return"string"==typeof n&&Bt.test(n)?parseFloat(n):n},!0),toPx:ee,toRem:ne,viewportLeft:I,viewportTop:$,fragmentFromTemplate:ut,fragmentFromChildren:ot,fragmentFromHTML:it,fragmentFromId:at,escape:Zt,parse:Ct(ct),Event:Y,delegate:et,isPrimaryButton:G,preventDefault:K,toKey:J,trapFocus:rt,trap:gt.deprecate(rt,"dom.trap() is now dom.trapFocus()"),events:{on:U,off:V,trigger:Q},on:gt.deprecate(Ct(nt,!0),"dom.on() is now dom.event()"),trigger:Ct(function(t,e){return Q(e,t),e},!0),event:Ct(nt,!0),schedule:Ct(ft,!0),animate:Ct(lt,!0),animateScroll:dt,scrollTo:St(dt,"scrollTo(px, node) renamed to animateScroll(px)"),scrollRatio:ht,disableScroll:pt,enableScroll:vt,requestEvent:tt,requestFrame:requestAnimationFrame.bind(null),requestFrameN:Ct(St(function(t,e){!function n(){return requestAnimationFrame(--t?n:e)}()},"requestFrameN() will be removed soon"),!0),features:It,safe:xt({left:0},{right:{get:function(){return t.innerWidth},enumerable:!0,configurable:!0},top:{get:function(){return B("padding-top",document.body)},enumerable:!0,configurable:!0},bottom:{get:function(){return t.innerHeight},enumerable:!0,configurable:!0}})}),xt(mt,{root:{value:document.documentElement,enumerable:!0},head:{value:document.head,enumerable:!0},body:{get:function(){return document.body},enumerable:!0},viewport:{get:function(){return document.scrollingElement},enumerable:!0}}),t.dom=mt}(this),function(t){"use strict"
function e(t){return g.query('a[href$="#'+t+'"]',document).filter(g.isInternalLink).concat(g.query('[data-href="#'+t+'"]',document))}function n(t){var e=M.get(t)
return e||(e={},M.set(t,e)),e}function r(t){var r=n(t),o=t.id
return r.node||(r.node=t),r.buttons||(r.buttons=S.cache&&o&&e(o)),r}function o(t){return S.cache&&t.buttons||t.node.id&&e(t.node.id)}function i(){var t,e=this.data||r(this.target)
e.active||(e.active=!0,this.preventDefault(),v&&console.log("[activate] default | target:",this.target.id,"data:",e),y(e.node).add(x),(t=o(e))&&t.forEach(function(t){g.classes(t).add(T)}))}function u(){var t,e=this.data||r(this.target)
e.active&&(e.active=!1,this.preventDefault(),v&&console.log("[deactivate] default | target:",this.target.id,"data:",e),y(e.node).remove(x),(t=o(e))&&t.forEach(function(t){g.classes(t).remove(T)}))}function a(t){var e=g.create("div",{class:"dialog-layer layer"}),n=g.create("div",{class:"dialog popable"}),r=g.create("button",{class:"close-thumb thumb"})
return g.append(n,t),g.append(e,n),g.append(e,r),g.append(document.body,e),n}function c(t){"mousedown"===t.type&&b(t.currentTarget,"click",function t(e){F(e.currentTarget,"click",t),e.preventDefault()})}function s(t){return!!t.defaultPrevented||(!g.isPrimaryButton(t)||(("keydown"===t.type||"keyup"===t.type)&&13!==t.keyCode||void 0))}function f(t,e){t.preventDefault(),"mousedown"===t.type&&c(t),w(e,"dom-activate",{relatedTarget:t.currentTarget})}function l(t){return(E(t.hash)?t.hash:t.getAttribute("href")).substring(1)}function d(t,e){var n=document.getElementById(e)
...
if(!s(t)&&O[e])return O[e](t)}var v=!1,m=t.Fn,g=t.dom,y=g.classes,b=g.events.on,F=g.events.off,w=g.events.trigger,E=m.isDefined,x="active",T="on",C=t.location,D=C.hash,S={cache:!0},M=new WeakMap
b(document,"dom-activate",function(t){if(!t.defaultPrevented){var e=r(t.target)
if(e.active)return void t.preventDefault()
t.data=e,t.default=i}}),b(document,"dom-deactivate",function(t){if(!t.defaultPrevented){var e=r(t.target)
if(!e.active)return void t.preventDefault()
t.data=e,t.default=u}})
var L=g.trigger("dom-activate"),A={},k={},O={dialog:function(t){var e,n=t.delegateTarget.getAttribute("data-href")||t.delegateTarget.hash||t.delegateTarget.href,r=n.substring(1),o=A[r]||(A[r]=document.getElementById(r))
...
var i=k[r]||(k[r]=a(e))
w(i,"dom-activate")}}
b(document,"click",g.delegate("[href]",h)),b(document,"click",g.delegate("a[target]",p)),g.ready(function(){if(g("."+x).forEach(L),D&&/^#\S+$/.test(D))try{g(D).forEach(L)}catch(t){}})}(this),function(t){"use strict"
...
m(document,"dom-activate",e),m(document,"dom-deactivate",n),m(t,"scroll",i),o()}(this),function(t){"use strict"
var e=t.dom,n=e.events.on,r=e.matches(".dialog-layer")
n(document,"dom-activate",function(t){t.defaultPrevented||r(t.target.parentNode)&&e.classes(t.target.parentNode).add("active")}),n(document,"dom-deactivate",function(t){t.defaultPrevented||r(t.target.parentNode)&&e.classes(t.target.parentNode).remove("active")})}(this)
