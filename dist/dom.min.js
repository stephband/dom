...
u[i]=o[2]?o[3]:parseFloat(o[3]),n.push(u)}U(i,n,u)}return tt(t,e,u,r)}function et(t,e){return _t.lastIndex=0,Z(_t,t,e)}function nt(t,e,n){return _t.lastIndex=0,tt(_t,t,e,n)}function rt(t,e){return t+e}function ot(t,e){return e+t}function it(t,e,n){for(var r=-1,o="";o.length<e-n.length;)o+=t[++r%t.length]
...
r>i?s=c:f=c,c=.5*(f-s)+s}return c}function dt(t){return jt.then(t),!0}function ht(t,e){function n(){var t=o.length
...
<<<<<<< HEAD
return e("curried",r,t,Lt(t,n,r))}}var At={url:/^(?:(?:(?:(?:[fht]{1,2}tps?:)?\/\/)?[-\w]+\.[-\w]+|\/[-\w.]+)(?:\/?[-\w.]+)*\/?|(?:[-\w.]+\/)+[-\w.]*)(?:[#?][#?!\[\]$\,;&=-\w.]*)?$/,email:/^((([a-z]|\d|[!#$%&'*+\-\/=?^_`{|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#$%&'*+\-\/=?^_`{|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,date:/^\d{4}-(?:0[1-9]|1[012])-(?:0[1-9]|[12][0-9]|3[01])$/,hexColor:/^(#)?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/,hslColor:/^(?:(hsl)(\())?\s?(\d{1,3}(?:\.\d+)?)\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?(\))?$/,rgbColor:/^(?:(rgb)(\())?\s?(\d{1,3})\s?,\s?(\d{1,3})\s?,\s?(\d{1,3})\s?(\))?$/,hslaColor:/^(?:(hsla)(\())?\s?(\d{1,3}(?:\.\d+)?)\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?,\s?([01](?:\.\d+)?)\s?(\))?$/,rgbaColor:/^(?:(rgba)(\())?\s?(\d{1,3})\s?,\s?(\d{1,3})\s?,\s?(\d{1,3})\s?,\s?([01](?:\.\d+)?)\s?(\))?$/,cssValue:/^(-?\d+(?:\.\d+)?)(px|%|em|ex|pt|in|cm|mm|pt|pc)?$/,cssAngle:/^(-?\d+(?:\.\d+)?)(deg)?$/,image:/(?:\.png|\.gif|\.jpeg|\.jpg)$/,float:/^[+-]?(?:\d*\.)?\d+$/,int:/^(-?\d+)$/},kt=Object.is||function(t,e){return t===e},Ot=v(O),qt=h(function(t,e){return void 0===e?void 0:(t(e),e)}),_t=/\[?([-\w]+)(?:=(['"])?([-\w]+)\2)?\]?\.?/g,Pt=t.performance&&t.performance.now?function(){return t.performance.now()/1e3}:function(){return+new Date/1e3},Nt=t.requestAnimationFrame,jt=Promise.resolve()
=======
return e("curried",r,t,Lt(t,n,r))}}var At={url:/^(?:(?:(?:(?:[fht]{1,2}tps?:)?\/\/)?[-\w]+\.[-\w]+|\/[-\w.]+)(?:\/?[-\w.]+)*\/?|(?:[-\w.]+\/)+[-\w.]*)(?:[#?][#?!\[\]$\,;&=-\w.]*)?$/,email:/^((([a-z]|\d|[!#$%&'*+\-\/=?^_`{|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#$%&'*+\-\/=?^_`{|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,date:/^\d{4}-(?:0[1-9]|1[012])-(?:0[1-9]|[12][0-9]|3[01])$/,hexColor:/^(#)?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/,hslColor:/^(?:(hsl)(\())?\s?(\d{1,3}(?:\.\d+)?)\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?(\))?$/,rgbColor:/^(?:(rgb)(\())?\s?(\d{1,3})\s?,\s?(\d{1,3})\s?,\s?(\d{1,3})\s?(\))?$/,hslaColor:/^(?:(hsla)(\())?\s?(\d{1,3}(?:\.\d+)?)\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?,\s?(\d{1,3}(?:\.\d+)?)%\s?,\s?([01](?:\.\d+)?)\s?(\))?$/,rgbaColor:/^(?:(rgba)(\())?\s?(\d{1,3})\s?,\s?(\d{1,3})\s?,\s?(\d{1,3})\s?,\s?([01](?:\.\d+)?)\s?(\))?$/,cssValue:/^(-?\d+(?:\.\d+)?)(px|%|em|ex|pt|in|cm|mm|pt|pc)?$/,cssAngle:/^(-?\d+(?:\.\d+)?)(deg)?$/,image:/(?:\.png|\.gif|\.jpeg|\.jpg)$/,float:/^[+-]?(?:\d*\.)?\d+$/,int:/^(-?\d+)$/},kt=Object.is||function(t,e){return t===e},Ot=v(O),qt=h(function(t,e){return void 0===e?void 0:(t(e),e)},!0),_t=/\[?([-\w]+)(?:=(['"])?([-\w]+)\2)?\]?\.?/g,Pt=t.performance&&t.performance.now?function(){return t.performance.now()/1e3}:function(){return+new Date/1e3},Nt=t.requestAnimationFrame,jt=Promise.resolve()
...
return t.on("pull",this.shift)},tap:function(t){return this.shift=bt.compose(qt(t),this.shift),this},toJSON:function(){return this.reduce(L,[])},toString:function(){return this.reduce(rt,"")},process:n(function(t){return t(this)},".process() is deprecated"),last:n(function(){var t=this
...
function e(t){return!t.validity||t.validity.valid}function n(t){return t.nextElementSibling&&b(t.nextElementSibling)}function r(t){var e,n,r=t,o=r.validity
for(e in o)if("valid"!==e&&o[e])return n=s.validation[w[e]],n&&t.setCustomValidity(n),{type:e,attr:w[e],name:t.name,text:r.validationMessage,node:t}}function o(t){for(var e=t.node,n=e;n.nextElementSibling&&b(n.nextElementSibling);)n=n.nextElementSibling
var r=s.create("label")
s.assign(r,{textContent:t.text,for:e.id,class:"error-label"}),h(n,r)}function i(t){p(t).add(F)}function u(t){for(var e=t;(e=m(e))&&b(e);)g(e)}var a=(Object.assign,t.Fn),c=t.Stream,s=t.dom,f=a.get,l=a.invoke,d=a.nothing,h=(a.once,s.after),p=(s.attribute,s.classes),v=s.matches,m=s.next,g=s.remove,y=v(".validateable, .validateable input, .validateable textarea, .validateable select"),b=v(".error-label"),F="validated",w={patternMismatch:"pattern",rangeOverflow:"max",rangeUnderflow:"min",stepMismatch:"step",tooLong:"maxlength",typeMismatch:"type",valueMissing:"required"}
s.event("input",document).map(f("target")).filter(y).tap(l("setCustomValidity",[""])).filter(e).each(u),s.event("focusout",document).map(f("target")).filter(y).each(l("checkValidity",d)),s.event("submit",document).map(f("target")).filter(y).each(i),document.addEventListener("invalid",c.of().map(f("target")).filter(y).tap(i).filter(function(t){return function(){return!t.apply(this,arguments)}}(n)).map(r).each(o).push,!0),s.validation=s.validation||{}}(this)
