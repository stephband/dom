...
function e(t,e,n,r){return r.toString=function(){return/function\s*[\w\d]*\s*\([,\w\d\s]*\)/.exec(n.toString())+" { ["+t+"] }"},Dt&&Object.defineProperty(r,"length",{value:e}),r}function n(t,e){return function(){return console.warn("Fn: deprecated - "+e),t.apply(this,arguments)}}function r(){if(!t.console)return e
...
var e=-1
return new bt(function n(){return++e>=t.length?void 0:void 0===t[e]?n():t[e]})},Timer:ht,nothing:St,id:i,noop:o,self:u,cache:l,compose:s,curry:h,choose:g,flip:v,once:p,overload:h(m),pipe:f,throttle:pt,wait:vt,equals:h(y),is:h(kt),isDefined:b,isIn:h(Ot,!0),isNot:h(F),and:h(function(t,e){return!(!t||!e)}),not:function(t){return!t},or:h(function(t,e){return t||e}),xor:h(function(t,e){return(t||e)&&!!t!=!!e}),isGreater:h(function(t,e){return e>t}),by:h(function(t,e,n){return A(e[t],n[t])},!0),byGreater:h(A),byAlphabet:h(function(t,e){return Tt.localeCompare.call(t,e)}),toType:w,toClass:x,toArray:E,toString:M,toInt:T,toFloat:parseFloat,toPlainText:function(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"")},toStringType:function(t,e){return function(n){for(var r=e.length;r--;)if(t[e[r]].test(n))return e[r]
