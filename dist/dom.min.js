...
return console.groupEnd(),console.log("⬅",t),t}}function o(){}function i(t){return t}function u(){return this}function a(t,e){return e(t)}function c(t,e){return function(){e.apply(this,k(arguments,t))}}function s(t,e){return function(n){return t(e(n))}}function f(){var t=arguments
...
t.splice(r,0,n)}function C(t,e){for(var n=t.length,r=n+n%2,o=0;(r=Math.floor(r/2))&&o+r<=n;)e(t[o+r-1])>=0&&(o+=r,r+=r%2)
=======
return n}function T(t){return parseInt(t,10)}function M(t){return t.toString()}function C(t,e,n){var r=S(t,function(t){return e(n,t)})
...
return o}function D(t,e){return-1===t.indexOf(e)&&t.push(e),t}function L(t,e){return t.push(e),t}function A(t,e){return t===e?0:t>e?1:-1}function k(t,e){return Array.isArray(e)?e.concat(Array.isArray(t)?t:E(t)):e.concat?e.concat(t):E(e).concat(Array.isArray(t)?t:E(t))}function O(t,e){return e.includes?e.includes(t):e.contains?e.contains(t):wt.includes?wt.includes.call(e,t):-1!==wt.indexOf.call(e,t)}function q(t,e){return e.map?e.map(t):wt.map.call(e,t)}function _(t,e){var n,r
...
return e>-1&&n.splice(e,1),t},e).concat(n)}function K(t){return t.unique?t.unique():j(D,[],t)}function V(t,e){return e.sort?e.sort(t):wt.sort.call(e,t)}function G(t,e){return null===e[t]?void 0:e[t]}function U(t,e,n){return"function"==typeof e.set?e.set(t,n):e[t]=n}function J(t,e,n){for(var r=n.length,o=-1;++o<r;)if(n[o][t]===e)return n[o]}function Q(t,e,n,r){var o=t.exec(e)
if(!o)throw new Error('Fn.getPath(path, object): invalid path "'+e+'"')
var i=o[1]
return r(t,e,o[3]?J(i,o[2]?o[3]:parseFloat(o[3]),n):n[i])}function Z(t,e,n){return t.lastIndex===e.length?n:n&&"object"==typeof n?Q(t,e,n,Z):void 0}function tt(t,e,n,r){var o=t.exec(e)
if(!o)throw new Error('Fn.getPath(path, object): invalid path "'+e+'"')
var i=o[1]
if(t.lastIndex===e.length){if(o[3])throw new Error('Fn.setPath(path, object): invalid path "'+e+'"')
return n[i]=r}var u=o[3]?J(i,o[2]?o[3]:parseFloat(o[3]),n):n[i]
...
r>i?s=c:f=c,c=.5*(f-s)+s}return c}function dt(t){return Nt.then(t),!0}function ht(t,e){function n(){var t=o.length
...
<<<<<<< HEAD
return n=t(),void 0===n&&(e.status="done"),r}}}var Ft=!0===t.DEBUG,wt=Array.prototype,xt=Number.prototype,Et=Object.prototype,Tt=String.prototype,Mt=Object.assign,St=Object.freeze(Object.defineProperties([],{shift:{value:o}})),Ct=180/Math.PI,Dt=function(){var t=function(){}
=======
return n=t(),void 0===n&&(e.status="done"),r}}}var Ft=!0===t.DEBUG,wt=Array.prototype,xt=Number.prototype,Et=Object.prototype,Tt=String.prototype,Mt=Object.assign,Ct=Object.freeze(Object.defineProperties([],{shift:{value:o}})),St=180/Math.PI,Dt=function(){var t=function(){}
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
Mt(bt.prototype,{shift:o,of:function(){return this.constructor.of.apply(this.constructor,arguments)},ap:function(t){var e=this.shift
...
return r.length?r.shift():o?void 0:(i=e(),"done"===t.status&&(o=!0,t.status=void 0),void 0!==i&&n.push(i),i)})},concat:function(){var t=E(arguments),e=this,n=yt(this,function r(){if(void 0===e)return void(n.status="done")
...
return yt(this,p(function(){return t.status="done",t.shift()}))},join:function(){var t=this,e=Ct
return yt(this,function n(){var r=e.shift()
return void 0!==r?r:void 0!==(e=t.shift())?n():void(e=Ct)})},latest:function(){var t=this
...
var e=this,n=[]
return yt(this,function(){for(var r;void 0!==(r=e.shift());)C(n,t,r)
...
return yt(this,function(){return gt(t)})},".last() is now .latest()")}),bt.prototype.toArray=bt.prototype.toJSON,t.Symbol&&(bt.prototype[Symbol.iterator]=function(){return this}),t.Fn=Mt(bt,{of:function(){return bt.from(arguments)},from:function(t){var e
...
function e(t,e){return e(t)}function n(t){return void 0!==t}function r(t){return"done"===t.status}function o(t){if(!t.shift)throw new Error("Stream: Source must create an object with .shift() "+Source)}function i(t,e){var n=e[C]
=======
throw new Error("Fn: from(object) object is not a list of a known kind (array, functor, stream, iterator).")},Timer:ht,nothing:Ct,id:i,noop:o,self:u,cache:l,compose:s,curry:h,choose:g,flip:v,once:p,overload:h(m),pipe:f,throttle:pt,wait:vt,equals:h(y),is:h(kt),isDefined:b,isIn:h(Ot,!0),isNot:h(F),and:h(function(t,e){return!(!t||!e)}),not:function(t){return!t},or:h(function(t,e){return t||e}),xor:h(function(t,e){return(t||e)&&!!t!=!!e}),isGreater:h(function(t,e){return e>t}),by:h(function(t,e,n){return A(e[t],n[t])},!0),byGreater:h(A),byAlphabet:h(function(t,e){return Tt.localeCompare.call(t,e)}),toType:w,toClass:x,toArray:E,toString:M,toInt:T,toFloat:parseFloat,toPlainText:function(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"")},toStringType:function(t,e){return function(n){for(var r=e.length;r--;)if(t[e[r]].test(n))return e[r]
...
return[0===e?Math.abs(n):0===n?Math.abs(e):Math.sqrt(e*e+n*n),Math.atan2(e,n)]},toCartesian:function(t){var e=t[0],n=t[1]
return[Math.sin(n)*e,Math.cos(n)*e]},toFixed:h(function(t,e){return xt.toFixed.call(e,t)}),limit:h(function(t,e,n){return n>e?e:n<t?t:n}),wrap:h(function(t,e,n){return(n<t?e:t)+(n-t)%(e-t)}),normalise:h(function(t,e,n){return(n-t)/(e-t)}),denormalise:h(function(t,e,n){return n*(e-t)+t}),rangeLog:h(function(t,e,n){return bt.denormalise(t,e,Math.log(n/t)/Math.log(e/t))}),rangeLogInv:h(function(t,e,n){return t*Math.pow(e/t,bt.normalise(t,e,n))}),cubicBezier:h(function(t,e,n,r){var o=1/(200*n),i=3*t[0],u=3*(e[0]-t[0])-i,a=1-i-u,c=3*t[1],s=3*(e[1]-t[1])-c
return st(1-c-s,s,c,lt(a,u,i,r,o))}),exponentialOut:h(function(t,e){return 1-Math.pow(1-e,t)}),append:h(ot),prepend:h(rt),postpad:h(ut),prepad:h(it),match:h(function(t,e){return t.test(e)}),exec:h(function(t,e){return t.exec(e)||void 0}),replace:h(function(t,e,n){return n.replace(t,e)}),slugify:function(t){if("string"==typeof t)return t.trim().toLowerCase().replace(/[\W_]/g,"-")},rspaces:/\s+/,now:_t,requestTick:dt,requestFrame:Pt,debug:r,deprecate:n,bind:n(c,"Review bind: it doesnt do what you think"),dB:n(o,"dB() is now todB()"),degToRad:n(o,"degToRad() is now toRad()"),radToDeg:n(o,"radToDeg() is now toDeg()"),nthRoot:h(n(function(t,e){return Math.pow(e,1/t)},"nthRoot(n, x) is now simply root(n, x)"),!1,2),Throttle:n(pt,"Throttle(fn, time) removed, is now throttle(fn, time)"),Wait:n(vt,"Wait(fn, time) removed, is now wait(fn, time)"),slice:h(n(function(t,e,n){return n.slice?n.slice(t,e):wt.slice.call(n,t,e)},"slice(n, m, object) is removed in favour of take(n) or rest(n)"),!0,3),returnThis:n(u,"returnThis() is now self()"),run:h(n(function(t,e){return e.apply(null,t)},"run() is now apply()"),!0,2),overloadLength:h(n(m,"overloadLength(map) is now overload(fn, map)"),!0,2)(function(){return arguments.length}),overloadTypes:h(n(m,"overloadTypes(map) is now overload(fn, map)"),!0,2)(function(){return wt.map.call(arguments,w).join(" ")})}),Object.defineProperties(bt,{empty:{get:n(function(){return Ct},"Fn.empty is now Fn.nothing")}})}(this),function(t){"use strict"
...
<<<<<<< HEAD
var n,r=this,i=new Promise(function(i,c){function s(){r.status="done",l=D}function f(t,e){delete r[C],t?l=new a(l,t,s):s(),i(e)}var l
n=function(){var i=u(r)
return l=new t(i,f,e),g&&o(l),l.stop||(l.stop=E),n=function(){return l},l}})
this[C]={},this.push=function(){var t=n()
=======
var n,r=this,i=new Promise(function(i,c){function s(){r.status="done",l=D}function f(t,e){delete r[S],t?l=new a(l,t,s):s(),i(e)}var l
n=function(){var i=u(r)
return l=new t(i,f,e),g&&o(l),l.stop||(l.stop=E),n=function(){return l},l}})
...
<<<<<<< HEAD
this._notify=t,this._stop=e,this._sources=n,this._values=o,this._buffer=i,this._i=0,this._update=r,w(function(e){o.push.apply(o,S(e)),e.on("push",r),e.on("push",t)},n)}function h(t){var n=this,r=[],o=[]
...
this.cancel=n.cancel||E,this.end=e,this.id=i(r)}var g=!1,y=t.Fn,b=Array.prototype,F=Object.assign,w=(y.curry,y.each),x=y.latest,E=y.noop,T=y.now,M=(y.nothing,y.rest,y.throttle,y.Timer),S=y.toArray,C=Symbol("events"),D={shift:E,push:E,start:E,stop:E}
=======
this._notify=t,this._stop=e,this._sources=n,this._values=o,this._buffer=i,this._i=0,this._update=r,w(function(e){o.push.apply(o,C(e)),e.on("push",r),e.on("push",t)},n)}function h(t){var n=this,r=[],o=[]
this.fns=r,t.each(function(){n.fns=o,r.reduce(e,void 0),r.length=0,o=r,r=n.fns})}function p(){var t=this.timer
this.queue=E,this.ref=t.request(this.update)}function v(t,e,n){var r=this
this._stop=e,this.timer=n,this.queue=p,this.update=function(){r.queue=p,t("push")}}function m(t,e,n){function r(e){o.value=e,t("push"),o.value=void 0,o.id=i(r)}var o=this,i=n.request
this.cancel=n.cancel||E,this.end=e,this.id=i(r)}var g=!1,y=t.Fn,b=Array.prototype,F=Object.assign,w=(y.curry,y.each),x=y.latest,E=y.noop,T=y.now,M=(y.nothing,y.rest,y.throttle,y.Timer),C=y.toArray,S=Symbol("events"),D={shift:E,push:E,start:E,stop:E}
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
return this.value=void 0,t},stop:function(){(0,this.cancel)(this.id),this.end()}}),c.clock=function(t){return new c(m,"number"==typeof t?new M(t):t||L)},c.prototype=F(Object.create(y.prototype),{clone:function(){var t=this,e=this.shift,n=[],r=[],o=new c(function(o,i){var u=r
...
var t=e()
<<<<<<< HEAD
return void 0!==t&&"done"!==o.status&&r.push(t),t},o},combine:function(t,e){return c.Combine(t,this,e)},merge:function(){var t=S(arguments)
=======
return void 0!==t&&"done"!==o.status&&r.push(t),t},o},combine:function(t,e){return c.Combine(t,this,e)},merge:function(){var t=C(arguments)
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
return n}function o(t,e,n){this.node=t,this.get=e,this.set=n}function i(t,e){for(var n=Object.keys(e),r=n.length;r--;)n[r]in t?t[n[r]]=e[n[r]]:t.setAttribute(n[r],e[n[r]])}function u(t,e){for(var n=Object.keys(e),r=n.length;r--;)t.setAttributeNS(null,n[r],e[n[r]])}function a(t){if(Wt[t])return Wt[t](arguments[1])
...
=======
n.add(t),requestAnimationFrame(function(){n.remove(t)})}function x(t){return r(t.children||t.querySelectorAll("*"))}function E(t,e){return e=e||document,r(e.querySelectorAll(t))}function T(t,e){return e.contains?e.contains(t):!!t.parentNode&&(t.parentNode===e||T(t.parentNode,e))}function M(t,e){return e.matches?e.matches(t):e.matchesSelector?e.matchesSelector(t):e.webkitMatchesSelector?e.webkitMatchesSelector(t):e.mozMatchesSelector?e.mozMatchesSelector(t):e.msMatchesSelector?e.msMatchesSelector(t):e.oMatchesSelector?e.oMatchesSelector(t):v(e)===t}function C(t,e){var n=arguments[2]
if(e&&e!==document&&e!==n&&11!==e.nodeType)return e=e.correspondingUseElement||e,M(t,e)?e:C(t,e.parentNode,n)}function S(t){return t.nextElementSibling||void 0}function D(t){return t.previousElementSibling||void 0}function L(t,e){return t.appendChild(e),t}function A(t,e){if(e instanceof yt||e instanceof bt)return L(t,e),e
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
return e&&(delete e.detail,xt(r,e)),r}function K(t){t.preventDefault()}function V(t){return 1===t.which&&!t.ctrlKey&&!t.altKey&&!t.shiftKey}function G(t){return Ut[t.keyCode]}function U(t,n,r,o){n=n.split(jt)
...
=======
t=It.transitionend}U(n,t,Z,e)}function et(t,e){return function(n){var r=C(t,n.target,n.currentTarget)
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
return document.addEventListener("focus",n,!0),_t(e),Jt=function(){Jt=Lt,document.removeEventListener("focus",n,!0),_t(function(){r.focus()})}}function ot(t){if(t.domFragmentFromChildren)return t.domFragmentFromChildren
var e=a("fragment")
...
<<<<<<< HEAD
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,kt(e,St(r[n],o),qt(n,r)))}function dt(t){return lt(.6,Ot(2),"scrollTop",mt.view,ee(t))}function ht(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function pt(t){t=t||document.documentElement
=======
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,kt(e,Ct(r[n],o),qt(n,r)))}function dt(t){return lt(.6,Ot(2),"scrollTop",mt.view,ee(t))}function ht(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function pt(t){t=t||document.documentElement
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
return e||(e={},k.set(t,e)),e}function r(t){var r=n(t),o=t.id
return r.node||(r.node=t),r.buttons||(r.buttons=A.cache&&o&&e(o)),r}function o(t){return A.cache&&t.buttons||t.node.id&&e(t.node.id)}function i(){var t,e=this.data||r(this.target)
e.active||(e.active=!0,this.preventDefault(),v&&console.log("[activate] default | target:",this.target.id,"data:",e),y(e.node).add(S),(t=o(e))&&t.forEach(function(t){g.classes(t).add(C)}))}function u(){var t,e=this.data||r(this.target)
e.active&&(e.active=!1,this.preventDefault(),v&&console.log("[deactivate] default | target:",this.target.id,"data:",e),y(e.node).remove(S),(t=o(e))&&t.forEach(function(t){g.classes(t).remove(C)}))}function a(t){var e=g.create("div",{class:"dialog-layer layer"}),n=g.create("div",{class:"dialog popable"}),r=g.create("button",{class:"close-thumb thumb"})
=======
xt(mt,{ready:re.then.bind(re),get:function(t){return document.getElementById(t)||void 0},find:gt.deprecate(function(t){return document.getElementById(t)||void 0},"dom.find(id) is now dom.get(id)"),query:Mt(E,!0),closest:Mt(C,!0),contains:Mt(T,!0),matches:Mt(M,!0),children:x,next:S,previous:D,assign:Mt(i,!0),create:a,clone:Rt,identify:p,append:Mt(A,!0),before:Mt(_,!0),after:Mt(P,!0),replace:Mt(N,!0),empty:k,remove:q,isElementNode:s,isTextNode:f,isCommentNode:l,isFragmentNode:d,isInternalLink:h,type:c,tag:v,attribute:Mt(m,!0),classes:y,addClass:Mt(b,!0),removeClass:Mt(F,!0),flashClass:Mt(w,!0),box:H,bounds:W,rectangle:St(H,"dom.rectangle(node) now dom.box(node)"),offset:Mt(R,!0),position:X,prefix:Kt,style:Mt(function(t,e){if(Yt[t])return Yt[t](e)
var n=B(t,e)
return"string"==typeof n&&Bt.test(n)?parseFloat(n):n},!0),toPx:ee,toRem:ne,viewportLeft:I,viewportTop:$,fragmentFromTemplate:ut,fragmentFromChildren:ot,fragmentFromHTML:it,fragmentFromId:at,escape:Zt,parse:Mt(ct),Event:Y,delegate:et,isPrimaryButton:V,preventDefault:K,toKey:G,trapFocus:rt,trap:gt.deprecate(rt,"dom.trap() is now dom.trapFocus()"),events:{on:U,off:J,trigger:Q},on:gt.deprecate(Mt(nt,!0),"dom.on() is now dom.event()"),trigger:Mt(function(t,e){return Q(e,t),e},!0),event:Mt(nt,!0),transition:Mt(ft,!0),schedule:St(ft,"dom: .schedule() is now .transition()"),animate:Mt(lt,!0),animateScroll:dt,scrollTo:St(dt,"scrollTo(px, node) renamed to animateScroll(px)"),scrollRatio:ht,disableScroll:pt,enableScroll:vt,requestEvent:tt,requestFrame:requestAnimationFrame.bind(null),requestFrameN:Mt(St(function(t,e){!function n(){return requestAnimationFrame(--t?n:e)}()},"requestFrameN() will be removed soon"),!0),features:It,safe:Et({left:0},{right:{get:function(){return t.innerWidth},enumerable:!0,configurable:!0},top:{get:function(){return B("padding-top",document.body)},enumerable:!0,configurable:!0},bottom:{get:function(){return t.innerHeight},enumerable:!0,configurable:!0}})}),Et(mt,{root:{value:document.documentElement,enumerable:!0},head:{value:document.head,enumerable:!0},body:{get:function(){return document.body},enumerable:!0},view:{get:function(){return document.scrollingElement},enumerable:!0},viewport:{get:function(){return console.warn("Deprecated: dom.viewport is now dom.view"),document.scrollingElement},enumerable:!0}}),t.dom=mt}(this),function(t){"use strict"
function e(t){return g.query('[href$="#'+t+'"]',g.body).filter(M(b,{a:g.isInternalLink,default:function(){return!0}})).concat(g.query('[data-href="#'+t+'"]',document))}function n(t){var e=k.get(t)
return e||(e={},k.set(t,e)),e}function r(t){var r=n(t),o=t.id
return r.node||(r.node=t),r.buttons||(r.buttons=A.cache&&o&&e(o)),r}function o(t){return A.cache&&t.buttons||t.node.id&&e(t.node.id)}function i(){var t,e=this.data||r(this.target)
e.active||(e.active=!0,this.preventDefault(),v&&console.log("[activate] default | target:",this.target.id,"data:",e),y(e.node).add(C),(t=o(e))&&t.forEach(function(t){g.classes(t).add(S)}))}function u(){var t,e=this.data||r(this.target)
e.active&&(e.active=!1,this.preventDefault(),v&&console.log("[deactivate] default | target:",this.target.id,"data:",e),y(e.node).remove(C),(t=o(e))&&t.forEach(function(t){g.classes(t).remove(S)}))}function a(t){var e=g.create("div",{class:"dialog-layer layer"}),n=g.create("div",{class:"dialog popable"}),r=g.create("button",{class:"close-thumb thumb"})
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
if(!s(t)&&N[e])return N[e](t)}var v=!1,m=t.Fn,g=t.dom,y=g.classes,b=g.tag,F=g.events.on,w=g.events.off,x=g.events.trigger,E=m.curry,T=m.isDefined,M=m.overload,C="active",S="on",D=t.location,L=D.hash,A={cache:!0},k=new WeakMap,O=E(function(t,e){return e(t)})
...
var q=g.trigger("dom-activate"),_={},P={},N={dialog:function(t){var e,n=t.delegateTarget.getAttribute("data-href")||t.delegateTarget.hash||t.delegateTarget.href,r=n.substring(1),o=_[r]||(_[r]=document.getElementById(r))
...
=======
F(document,"click",g.delegate("a[href]",h)),F(document,"click",g.delegate("a[target]",p)),g.ready(function(){if(g("."+C).forEach(q),L&&/^#\S+$/.test(L))try{g(L).forEach(q)}catch(t){}})}(this),function(t){"use strict"
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
...
<<<<<<< HEAD
if(r&&(r.pageX!==e.pageX||r.pageY!==e.pageY))return r}function o(t){A(t)&&(e(t)||(C(document,M.move,i,[t]),C(document,M.cancel,u,[t])))}function i(t,e){e.push(t),d(t,e,t,a)}function u(t,e){a()}function a(){D(document,M.move,i),D(document,M.cancel,u)}function c(t){if(!T[t.target.tagName.toLowerCase()]){var e=t.changedTouches[0],n={target:e.target,pageX:e.pageX,pageY:e.pageY,identifier:e.identifier,touchmove:function(){s.apply(this,arguments)},touchend:function(){f.apply(this,arguments)}}
C(document,S.move,n.touchmove,[n]),C(document,S.cancel,n.touchend,[n])}}function s(t,e){var n=r(t,e[0])
n&&d(t,e,n,l)}function f(t,e){n(t.changedTouches,e[0].identifier)&&l(e)}function l(t){D(document,S.move,t[0].touchmove),D(document,S.cancel,t[0].touchend)}function d(t,e,n,r){var o=n.pageX-e[0].pageX,i=n.pageY-e[0].pageY
...
C(document,"mousedown",o),C(document,"touchstart",c)}(this),function(t){"use strict"
=======
if(r&&(r.pageX!==e.pageX||r.pageY!==e.pageY))return r}function o(t){A(t)&&(e(t)||(S(document,M.move,i,[t]),S(document,M.cancel,u,[t])))}function i(t,e){e.push(t),d(t,e,t,a)}function u(t,e){a()}function a(){D(document,M.move,i),D(document,M.cancel,u)}function c(t){if(!T[t.target.tagName.toLowerCase()]){var e=t.changedTouches[0],n={target:e.target,pageX:e.pageX,pageY:e.pageY,identifier:e.identifier,touchmove:function(){s.apply(this,arguments)},touchend:function(){f.apply(this,arguments)}}
S(document,C.move,n.touchmove,[n]),S(document,C.cancel,n.touchend,[n])}}function s(t,e){var n=r(t,e[0])
n&&d(t,e,n,l)}function f(t,e){n(t.changedTouches,e[0].identifier)&&l(e)}function l(t){D(document,C.move,t[0].touchmove),D(document,C.cancel,t[0].touchend)}function d(t,e,n,r){var o=n.pageX-e[0].pageX,i=n.pageY-e[0].pageY
if(!(o*o+i*i<E*E)){var u,a=e[0],c=e[0].target
r(e),L(e[0].target,"dom-touch",{pageX:a.pageX,pageY:a.pageY,detail:function(){return u||(u=b(c,e)),u}})}}function h(t,e){e.touch=t,e.timeStamp=t.timeStamp,e.stream.push(t)}function p(t,e){e.target
v(),e.stream.stop()}function v(){D(document,M.move,h),D(document,M.end,p)}function m(t,e){var n=r(t,e)
n&&(t.preventDefault(),e.touch=n,e.timeStamp=t.timeStamp,e.stream.push(n))}function g(t,e){n(t.changedTouches,e.identifier)&&(y(e),e.stream.stop())}function y(t){D(document,C.move,t.activeTouchmove),D(document,C.end,t.activeTouchend)}function b(t,e){var n=w.from(e).map(function(t){return{x:t.pageX-e[0].pageX,y:t.pageY-e[0].pageY,time:(t.timeStamp-e[0].timeStamp)/1e3}}),r={stream:n,target:t,touch:void 0,identifier:e[0].identifier}
return void 0===r.identifier?(S(t,"click",k),S(document,M.move,h,r),S(document,M.cancel,p,r)):(r.activeTouchmove=function(t,e){m(t,e)},r.activeTouchend=function(t,e){g(t,e)},S(document,C.move,r.activeTouchmove,r),S(document,C.end,r.activeTouchend,r)),n.then(function(){setTimeout(function(){D(t,"click",k)},200)}),n}var F=t.Fn,w=t.Stream,x=t.dom,E=8,T={textarea:!0,input:!0,select:!0,button:!0},M={move:"mousemove",cancel:"mouseup dragstart",end:"mouseup"},C={move:"touchmove",cancel:"touchend",end:"touchend"},S=(F.requestTick,x.events.on),D=x.events.off,L=x.events.trigger,A=x.isPrimaryButton,k=x.preventDefault
...
return t.parentNode.clientWidth-n}function r(t,e){var n=u.box(t).left,r=u.box(e).left,o=Math.round(n-r-u.style("margin-left",e))
...
var r=u.box(e).left,o=u.box(n).left,i=r-o-u.style("margin-left",e)
n.style.transform="translate("+-i+"px, 0px)",t.preventDefault()}}})}(this),function(t){"use strict"
var e=t.Fn,n=t.dom,r=e.noop,o=n.events.on,i=n.events.off,u=n.events.trigger,a=n.disableScroll,c=n.enableScroll,s=n.trapFocus,f=r,l=n.matches(".focusable, [focusable]")
...
w(),c.trigger("dom-deactivate",u)}var n,r,o=t.timeStamp;(F>o||o>F+g)&&(n=p(c.view,e),r=c.safe.top,F=o+1e3*y,w=d(y,b,"scrollTop",c.view,n[1]-r)),t.default(),u=e}}}function n(t){if(t.default){var e=t.target
m(e)&&(t.default(),e===u&&(u=void 0))}}function r(){return{left:0,top:0,right:t.innerWidth,bottom:t.innerHeight,width:t.innerWidth,height:t.innerHeight}}function o(){for(var t=c(".locateable"),e=t.map(h).sort(s("top")),n=r(),o=-1;e[++o]&&!(e[o].top>n.height/2););if(!(--o<0||o>=e.length)){var i=t[o]
if(u){if(i===u)return
c.trigger("dom-deactivate",u)}c.trigger("dom-activate",i)}}function i(t){F>=t.timeStamp||(F=t.timeStamp,o())}var u,a=t.Fn,c=t.dom,s=a.by,f=a.noop,l=a.exponentialOut,d=c.animate,h=c.box,p=c.offset,v=c.events.on,m=c.matches(".locateable, [locateable]"),g=90,y=.8,b=l(6),F=0,w=f
v(document,"dom-activate",e),v(document,"dom-deactivate",n),v(t,"scroll",i),o(),c.activeMatchers.push(m)}(this),function(t){"use strict"
<<<<<<< HEAD
function e(t){return!t.validity||t.validity.valid}function n(t){return t.nextElementSibling&&m(F,t.nextElementSibling)}function r(t){var e,n=t,r=n.validity
for(e in r)if("valid"!==e&&r[e])return{type:e,attr:w[e],name:t.name,text:s.validation[w[e]]||n.validationMessage,node:t}}function o(t){for(var e=t.node,n=e;n.nextElementSibling&&m(F,n.nextElementSibling);)n=n.nextElementSibling
var r=s.create("label")
s.assign(r,{textContent:t.text,for:e.id,class:"error-label"}),p(n,r),"customError"===t.type&&(n.setCustomValidity(t.text),s.on("input",n).take(1).each(function(){n.setCustomValidity("")}))}function i(t){v(t).add(b)}function u(t){for(var e=t;e.nextElementSibling&&m(F,e.nextElementSibling);)e=e.nextElementSibling,g(e)}var a=(Object.assign,t.Fn),c=t.Stream,s=t.dom,f=a.get,l=a.invoke,d=a.nothing,h=a.once,p=s.after,v=(s.attribute,s.classes),m=s.matches,g=s.remove,y=s.matches(".validateable, .validateable input, .validateable textarea, .validateable select"),b="validated",F=".error-label",w={patternMismatch:"pattern",rangeOverflow:"max",rangeUnderflow:"min",stepMismatch:"step",tooLong:"maxlength",typeMismatch:"type",valueMissing:"required"}
s.event("input",document).map(f("target")).filter(y).filter(e).each(u),s.event("focusout",document).map(f("target")).filter(y).each(l("checkValidity",d)),s.event("submit",document).map(f("target")).filter(y).each(i),document.addEventListener("invalid",c.of().map(f("target")).tap(h(i)).filter(function(t){return function(){return!t.apply(this,arguments)}}(n)).map(r).each(o).push,!0),s.validation=s.validation||{}}(this)
=======
function e(t){return!t.validity||t.validity.valid}function n(t){return t.nextElementSibling&&m(w,t.nextElementSibling)}function r(t){var e,n=t,r=n.validity
for(e in r)if("valid"!==e&&r[e])return{type:e,attr:x[e],name:t.name,text:s.validation[x[e]]||n.validationMessage,node:t}}function o(t){for(var e=t.node,n=e;n.nextElementSibling&&m(w,n.nextElementSibling);)n=n.nextElementSibling
var r=s.create("label")
s.assign(r,{textContent:t.text,for:e.id,class:"error-label"}),p(n,r),"customError"===t.type&&(n.setCustomValidity(t.text),s.on("input",n).take(1).each(function(){n.setCustomValidity("")}))}function i(t){v(t).add(F)}function u(t){for(var e=t;(e=g(e))&&m(w,e);)y(e)}var a=(Object.assign,t.Fn),c=t.Stream,s=t.dom,f=a.get,l=a.invoke,d=a.nothing,h=a.once,p=s.after,v=(s.attribute,s.classes),m=s.matches,g=s.next,y=s.remove,b=s.matches(".validateable, .validateable input, .validateable textarea, .validateable select"),F="validated",w=".error-label",x={patternMismatch:"pattern",rangeOverflow:"max",rangeUnderflow:"min",stepMismatch:"step",tooLong:"maxlength",typeMismatch:"type",valueMissing:"required"}
s.event("input",document).map(f("target")).filter(b).filter(e).each(u),s.event("focusout",document).map(f("target")).filter(b).each(l("checkValidity",d)),s.event("submit",document).map(f("target")).filter(b).each(i),document.addEventListener("invalid",c.of().map(f("target")).filter(b).tap(h(i)).filter(function(t){return function(){return!t.apply(this,arguments)}}(n)).map(r).each(o).push,!0),s.validation=s.validation||{}}(this)
>>>>>>> 17362ba9a266c2f9ca6dfc98d1328661334ed13a
